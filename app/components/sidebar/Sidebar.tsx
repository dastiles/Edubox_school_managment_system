  ...
  useEffect(() => {
    function handleMouseOver(e: MouseEvent) {
      ...
      if (
        ...
        document.querySelector<HTMLElement>("#toggle_btn")?.offsetParent !==
          null
      ) {
        ...
        if (targ) {
          ...
          document
            .querySelectorAll<HTMLElement>(".subdrop + ul")
        ...
        <div className="sidebar-inner slimscroll">
          <div id="sidebar-menu" className="sidebar-menu">
            ...
            <ul>
              ...
              <li
                className={`${
                  "/admindashboard" === pathName ? "active submenu" : "submenu"
                }`}
              >
                <Link
                  href="#"
              ...
              >
                ...
                {isSideMenu == "Students" ? (
                  ...
                  >
                    <SideBarLink link="/students" title="Student Grid" />
                    <SideBarLink
              ...
              >
                ...
                {isSideMenu == "Teachers" ? (
                  ...
                  >
                    <SideBarLink
                      link="/teachers/teacherlist"
                      title="Teacher Grid"
                    />
                    <SideBarLink link="/teachers" title="Teacher List" />
                    <SideBarLink
                      link="/teachers/addteacher"
                      title="Teacher Add"
                    />
                  </ul>
                ) : (
              ...
              <li
                className={`${
                  "/department" === pathName ||
                  "/department/adddepartment" === pathName ||
                  "/department/editdepartment" === pathName
                    ? "active submenu"
                    : "submenu"
                }`}
              >
              ...
              <li
                className={`${
                  "/event" === pathName || "/event" === pathName ? "active" : ""
                }`}
              >
                <Link href="/event">
