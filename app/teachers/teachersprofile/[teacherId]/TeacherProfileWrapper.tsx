                                    ...
                                    <div className="student-personals-grp">
                                        <div className="card">
                                            <div className="card-body">
                                                ...
                                                <StudentActivity title={teacher.email!} heading="Email" />
                                                <StudentActivity title={teacher.phone_number!} heading="Phone Number" />
                                                <StudentActivity title={teacher.gender!} heading="Gender" />
                                                <StudentActivity title={teacher.subject_taught!} heading="Department" />
                                                <StudentActivity title={teacher.address!} heading="Address" />
